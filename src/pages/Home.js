...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      (isDashboardRoute && restrictedBrowsers.includes(browserName))
    ) {
      ...
      <div className="w-full flex justify-center">
        ...
        <div className="w-full flex justify-center">
          <div className="flex flex-col pt-3 space-y-3 w-full">
            <TonConnectUIProvider manifestUrl="https://kabosutapgame.netlify.app/tonconnect-manifest.json">
              <UserProvider>
                    ...
                    <>
                      ...
                      <div
                        ...
                        className={`${loading ? "invisible" : "visible"
                          } bg-[#171717] z-30 flex flex-col rounded-tr-[20px] rounded-tl-[20px] fixed bottom-0 ${isIOS ? "pb-6" : "pb-3"
                          } left-0 right-0 justify-center items-center px-3`}
                      >
                        <Footer />
