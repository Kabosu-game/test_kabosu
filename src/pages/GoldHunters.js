...
const GoldHunters = () => {
  ...
  useEffect(() => {
    console.log('claimExchangePoint called');
    if (id) {
  ...
  useEffect(() => {
    console.log('useEffect SavedEndTime called');
  ...
  useEffect(() => {
    console.log('useEffect Initialized called');
    if (initialized) {
        ...
        <Animate>
          ...
          <div className='w-full flex justify-center flex-col space-y-3'>
            ...
            <div className='w-full relative h-screen bg-divider shadowtop rounded-tl-[40px] rounded-tr-[40px]'>
              ...
              <div
                className={`${characterMenu === true && selectedCharacter.name === '' ? "visible" : "invisible"
