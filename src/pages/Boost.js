...
const userLevels = [
  { id: 1, name: 'Bronze', icon: 'niveau1.jpeg', tapBalanceRequired: 1000000 },
  { id: 2, name: 'Silver', icon: 'niveau2.jpeg', tapBalanceRequired: 10000000 },
  { id: 3, name: 'Gold', icon: 'niveau3.jpeg', tapBalanceRequired: 100000000 },
  { id: 4, name: 'Platinum', icon: 'niveau4.jpeg', tapBalanceRequired: 1000000000 },
  { id: 5, name: 'Diamond', icon: 'niveau5.jpeg', tapBalanceRequired: 2500000000 },
  { id: 6, name: 'Master', icon: 'niveau6.jpeg', tapBalanceRequired: 10000000000 },
];
...
<button onClick={() => setShowLevel(true)} className='w-[55%] flex space-x-1 items-center'>
    ...
    <div className='w-fit py-[2px] px-3 flex items-center space-x-1 justify-center border-[1px] border-cards rounded-[25px]'>
      <span className='w-[14px] levelImg'>
        <img alt="daxy" src={images.logo} className='w-full' />
      </span>
 ...
 {/*  */}
    ...
    <div ref={infoRefTwo} className={`${
          ...
          <div className="w-full items-center justify-center flex flex-col pt-[20px]">
            ...
            {texts.projectSymbol} bot work duration is 3 hours
                        </p>
          </div>
